...
class SmartSaveUI(QtWidgets.QDialog):
    ...
    def _browse_folder(self):
        """Opens a dialouge box to browse the folder"""
...
class SceneFile(object):
    ...
    def increment_save(self):
        """ Increments the version and the scene file.

        If the existing version of a file already exists, it should increment
        from the largest number of version number available in the folder.
